...
report_resources > ./output_report/repResources_OptimizeReg.txt
report_timing > ./output_report/reportTiming_OptimizeReg.txt
report_area > ./output_report/reportArea_OptimizeReg.txt
