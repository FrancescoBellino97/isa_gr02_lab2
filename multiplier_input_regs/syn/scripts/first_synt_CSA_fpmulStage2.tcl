...
report_resources >./output_report/repResources_CSAstage2.txt
report_timing > ./output_report/reportTiming_CSAstage2.txt
report_area > ./output_report/reportArea_CSAstage2.txt
